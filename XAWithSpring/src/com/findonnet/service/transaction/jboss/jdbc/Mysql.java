package com.findonnet.service.transaction.jboss.jdbc;
...
public class Mysql implements DynamicClass
{
	...
	try
	{
	    ...
	    if (index1 == -1)
	    {
		throw new SQLException("Mysql.getDataSource - "+jdbcLogger.logMesg.getString("com.arjuna.ats.internal.jdbc.drivers.invaliddb")+" Mysql");
	    }
	    else
	    {
		/*
	...
	{
	    throw new SQLException("Mysql "+jdbcLogger.logMesg.getString("com.arjuna.ats.internal.jdbc.drivers.exception")+e2);
	}
    }
